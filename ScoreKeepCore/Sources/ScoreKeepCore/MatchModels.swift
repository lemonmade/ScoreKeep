...
public class Match {
    ...
    public init(
        from template: MatchTemplate, markAsUsed: Bool = true, sets: [MatchSet] = [MatchSet()],
        startedAt: Date = .now, endedAt: Date? = nil, startingServe: MatchTeam? = nil
    ) {
...
public class MatchGame {
    ...
    public init(
        ...
        let usScores: [MatchGameScore] = Array(
            repeating: MatchGameScore(.us, at: startedAt), count: us)
        let themScores: [MatchGameScore] = Array(
            repeating: MatchGameScore(.them, at: startedAt), count: them)
...
public struct MatchGameScore: Codable, Equatable {
    ...
    public init(
        us: Int = 0, them: Int = 0, serve: MatchTeam? = nil, at timestamp: Date = .now,
        source: MatchGameScoreSource = .point
    ) {
    ...
    public init(
        _ team: MatchTeam, serve: MatchTeam? = nil, scoring: MatchServiceScoring? = nil,
...
public struct MatchScoringRules: Codable, Equatable {
    ...
    public var lastSetScoring: MatchSetScoringRules?

    public init(
        winAt: Int? = nil, winBy: Int? = nil, maximum: Int? = nil, playItOut: Bool = false,
        setScoring: MatchSetScoringRules, lastSetScoring: MatchSetScoringRules? = nil
    ) {
        self.winAt = winAt
        self.winBy = winBy
...
public struct MatchSetScoringRules: Codable, Equatable {
    ...
    public var lastGameScoring: MatchGameScoringRules?

    public init(
        winAt: Int? = nil, winBy: Int? = nil, maximum: Int? = nil, playItOut: Bool = false,
        gameScoring: MatchGameScoringRules, lastGameScoring: MatchGameScoringRules? = nil
    ) {
        self.winAt = winAt
        self.winBy = winBy
        self.maximum = maximum
    ...
    public func canPlayAnotherGame(_ set: MatchSet) -> Bool {
        ...
        print(
            "winAt: \(winAt ?? -1), hasWinner: \(hasWinner(set)), playItOut: \(playItOut), impliedMaximumGameNumber: \(maximumGameCount ?? -1)"
        )
